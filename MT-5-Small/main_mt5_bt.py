...
csv_file = "/home/pooja/Prince/llama-2/21jan_Tag.csv"   
...
training_args = Seq2SeqTrainingArguments(
    output_dir="./mt5-small-hi-bhili-finetuned",
...
model.save_pretrained("./mt5-small-hi-bhili-finetuned")
tokenizer.save_pretrained("./mt5-small-hi-bhili-finetuned")
